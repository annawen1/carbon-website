...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
      ...
      href="https://web-components.carbondesignsystem.com/?path=/story/components-toggletip--default"
      >
...
>
  <ComponentVariant
    ...
    links={{
      ...
      'Web Components':
        'https://web-components.carbondesignsystem.com/?path=/story/components-toggletip--default',
    }}
  >
    {`
    <Toggletip>
