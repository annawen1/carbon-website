...
>
  ...
  <ComponentVariant
    ...
    links={{
      ...
      'Web Components':
        'https://web-components.carbondesignsystem.com/?path=/story/components-tile--radio',
    }}
  >
    {`
    <TileGroup
  ...
  <ComponentVariant
    ...
    links={{
      ...
      'Web Components':
        'https://web-components.carbondesignsystem.com/?path=/story/components-tile--selectable',
    }}
  >
    {`
    <div
