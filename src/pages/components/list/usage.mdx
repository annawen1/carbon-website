...
>
  <ComponentVariant
    ...
    links={{
      ...
      Vue: 'http://vue.carbondesignsystem.com/?path=/story/components-cvlist--default',
      'Web Components':
        'https://web-components.carbondesignsystem.com/?path=/story/components-ordered-list--default',
    }}
  >
    {`
    <OrderedList>
  ...
  <ComponentVariant
    ...
    links={{
      ...
      Vue: 'http://vue.carbondesignsystem.com/?path=/story/components-cvlist--default',
      'Web Components':
        'https://web-components.carbondesignsystem.com/?path=/story/components-unordered-list--default',
    }}
  >
    {`
      <UnorderedList>
